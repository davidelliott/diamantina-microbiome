...
\subsection{Soil properties}
Soils were all poor in carbon and nitrogen content, with carbon  and nitrogen (Figure \ref{fig:chem}). Dune and dune flank sites contained approximately double the amount of carbon (approximately 0.35 \% w/w) and nitrogen (approximately 0.055 \% w/w) compared to nebkha and pan sites (approximately 0.2 \% and 0.35 \% respectively). The pH also differed in a similar pattern with dune and dune flank sites being similar around pH 6.5 whereas pan and nebkha sites were higher at around pH 7.0.
