...
wanted_cols <- colnames((sigtab))[1:5]
...
write.csv(otus.df[,c(rank_names(ab)[1:7],sample_names(ab.rel.merged),"sig",wanted_cols)],"results/Elliott_Diamantina_Microbiome_Table_S4[otus].csv")
