...
kable(partsizetab, digits=2, caption = "Mean percent volume of sediment by particle size in $\\mu$m for all sites. \\label{tab:partsize}",col.names=c("$<$4","4-16","16-63","63-250","$>$250"),escape = FALSE)
@
