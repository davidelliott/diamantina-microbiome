...
#parallel_assign_taxonomy_rdp.py -r /home/david/gg_13_8_otus/rep_set/99_otus.fasta -t /home/david/gg_13_8_otus/taxonomy/99_otu_taxonomy.txt -i /home/david/git/diamantina-microbiome/data/all.otus.fasta -o rdp-assigned-tax-99/ -O 3

## assign taxonomy with greengenes
assign_taxonomy.py -m rdp -r /home/david/gg_13_8_otus/rep_set/99_otus.fasta -t /home/david/gg_13_8_otus/taxonomy/99_otu_taxonomy.txt -i /home/david/git/diamantina-microbiome/data/all.otus.fasta -o rdp-assigned-tax-99/

## assign taxonomy with SILVA/uclust
assign_taxonomy.py -m uclust -r /home/david/silva132/rep_set/rep_set_16S_only/99/silva_132_99_16S.fna -t /home/david/silva132/taxonomy/16S_only/99/majority_taxonomy_7_levels.txt -i /home/david/git/diamantina-microbiome/data/all.otus.fasta -o uclust-silva-assigned-tax-99/

# prepare biom files with taxonomy included
...
biom add-metadata -i all.otutab.biom -o all.otutab.w.taxa-silva.biom --observation-metadata-fp uclust_assigned_taxonomy/all.otus_tax_assignments.txt --sc-separated taxonomy --observation-header OTUID,taxonomy
...
biom head -i all.otutab.w.taxa-silva.biom
