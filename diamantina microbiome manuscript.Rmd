...
cyano.plot <- ggplot(cyano.df, aes(x=zone_code, y=Abundance, color = element, shape = element)) + geom_boxplot() + facet_wrap(~Genus, nrow=1) + scale_y_log10(name="relative abundance (%)",labels=comma)
