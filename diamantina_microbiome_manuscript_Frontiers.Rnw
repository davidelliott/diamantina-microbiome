...
\def\Authors{David R. Elliott\,$^{1,*}$, Andrew D. Thomas\,$^{2}$, Craig Strong\,$^{3}$ and Johanna Bullard\,$^{4}$}
...
$^{4}$Department of Geography, School of Social, Political and Geographical Sciences, Loughborough University, Leicestershire, UK
}
...
\title[Microbes and landscape stability]{Differential Mobilistation of Soil Bacteria by wind in Drylands, and Relevance of Microbial Dispersal Strategies to Landscape Stability} 
...
The hypotheses are all conceptually linked around understanding the survival and dispersal of biocrust microbes in the harsh environment of the soil surface at our field site, which is also presented in Figure \ref{fig:dispersal-hazards}. On rare occasions the claypan is flooded by water carried by the rivers from areas to the north which experience more rainfall. Most of the time the region is dry and the soil surface is covered by biological soil crusts, the biota of which are mostly unknown although the phototrophs in the area have been identified by Strong et al... (presumably - please advise). This environment presents considerable challenges to life at the soil surface, and these vary due to the different conditions in each compartment of the system. However, these compartments are linked by the actions of wind and water which can transfer sediment and inoculum (Figure \ref{fig:dispersal-hazards}), thus the system is highly dynamic and there is potential for microbes to be adapted either as specialists exploiting one compartment or generalists able to exploit multiple aspects of the same system.
...
We have found strong evidence that microbes are differentially liberated from the dryland soil surface by moderate wind, and this provides numderous opportunities to investigate whether microbes are specifically adapted in this regard or not. Our original hypotheses motivating this work are predicated on the assumption that microbes tend to be adapted for their environment, thus whether they stick or fly is most likely a consequence of natural selection and perhaps also ecosystem engineering. The question of whether biocrust microbes are ecosystem engineers is perhaps a better way of asking whether microbes are active players in geomorphic processes and landscape stability. If their actions change the environment, then the answer to both can be "yes". There is ample evidence for this in the existing literature, so in the present work we sought to shed light on the selective pressures and biological adaptations which may be driving microbial phenotypes at the soil surface. The dune and pan sites present similar environments but different challenges for survival at the soil surface, especially in relation to disperal and colonisation. The claypan can be completely engulfed by flood events lasting ?? and leading to complete replacement of the soil surface, but in contrast the dune sites never experience flooding. Due to the relatively short flooding interval (typically 3 years), organisms colonising the claypan soil will face extreme competition as they fill the new niche. Vegetative growth is therefore not expected to be an effective strategy for colonising the recently flooded claypan, hence we expected that more generalised taxa already established in the rivers are most likely to be primary colonisers of the pan surface. We also expect due to the recurrent flooding, that succession will not proceed far, therefore the claypan biocrusts are most likely to conatain organisms that are adapted for this lifecycle including both aquatic and terrestrial phases. Whilst it is possible that the pan biocrusts are entirely composed of aquatic species we find this unlikely given the long geological timescales and widespread global presence of similar systems having provided ample opportunity for organisms to efficiently exploit these systems. 

The sand dune biocrusts do not experience wholesale disruption and can generally be regarded as quite stable. Therefore succession can take place and un-crusted sites exposed by localised disturbances can likely be re-clonised by vegetative growth from nearby areas. Large scale burial of sand dunes does occur as a consequence of Aeolian deposition (REF), but these events do not disrupt the crust or bury it deeply, and it is known that biocrust biota can move vertically up to xx mm in a day so shallow burial is not expected to threaten biocrust survival. This occasional partial burial followed by upward migration of biocrust biota could contribute significantly to the stability of sand dunes. Our data support these ideas, showing that sand dunes have the highest proportion of taxa that resist wind erosion, thus they are adapted in a way that promotes stability in the dune. This kind of adaptation may also inhibit dispersal by the wind, and this is consistent with the idea that vegetative growth should be an effective dispersal mechanism within the stable dune environment. 

The nebkha sites within the claypan were the only place where a high proportion of the biota was identified as being easily mobilised by wind (xx \%; Figure \ref{fig:waterp}). This was not a direct measurement, but based upon taxa from the dune flank that were easily mobilised and measuring their abundance in the nebkha. We anticipate that a direct measurement on the nebkha sites would yield a higher proportion but this would be extremely difficult to do because the nebkha morphology is incompatible with wind tunnel apparatus. It should also be noted that our techniques do not establish direction of transport, therefore a proportion (possibly the majority) of the taxa mobilised from the dune flank by wind treatment are likely to have originated from the pan and nebkha sites. The reason for a high proportion of wind-mobile biota on the nebkha is unlikely to be a purely physical phenomenon, since the nebkha physico-chemical properties are intermediate to the dune and pan compartments (Figure \ref{fig:chem}). A biological explanation may be that nebkha are inhabited by biocrusts that rely principally on aerial disperal, because they are adapted as primary colonisers of newly exposed niches. Such organisms would need to have the capacity for adhesion to establish a colony in the new niche, but also an ability to disperse from the colony. This could be achieved by phenotypic switching which is a well known phenomenon in biofilms (REF). Furthermore, biocrust organisms adapted for aerial dispersal would also need adaptations for survival in the air, such as small size and resistance to dessication and radiation. Alternatively, it is possible that the main niche of these microbes is in fact the atmosphere, and their presence in biocrusts is transitory, for instance to acquire nutrients before moving on.

One example of possible adaptation for mobilisation is a \textit{Deinococcus} species which was found to be significantly more likely to become airborne than to stay in the soil during wind treatment. This genus is well known for its remarkable ability to withstand dessication and all kinds of radiation \citep{makarova2001genome}. It has been found in desert soils before (e.g. \citet{rainey2005extensive}) but according to the latest version of Bergey's manual \citep{whitman2015bergey} the natural habitat of this organism remains unknown. We suggest then that the habitat of this ancient lineage is in fact the biocrust top surface, and it is adapted for wind dispersal - a hypothesis supported by the present results. With such ecology \textit{Deinococcus} species may serve a protective function to the biocrust, and can also ensure that they quickly colonise any newly emerging biocrust which will immediately benefit from such protection early in their development. In contrast to \textit{Deinococcus} species many OTUs were found to resist becoming airborne, and the relevance of this in terms of wind erosion, land management, and geo-engineering can all be explored. Such organisms (including most \textit{Cyanobacteria}) are less likely to be dispersed by the wind, and therefore in severely degraded areas biocrust may not re-form easily because the inoculum must come from a local source (e.g. vegetative growth or transport by an animal). Possible difficulties for biocrusts to regenerate after extreme sustained disturbance is something we suggested as a risk in \citet{elliott2014niche}, and seems to be supported by the present results.
