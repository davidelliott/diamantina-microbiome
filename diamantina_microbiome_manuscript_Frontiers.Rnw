...
<<chem_out, echo=FALSE,fig.height=3,fig.cap='Soil properties. \\label{fig:chem}', warning=FALSE, cache=TRUE>>=
# melt for plotting
...
<<phyla_out, echo=FALSE, warning=FALSE, cache=TRUE,fig.cap='Relative abundance of bacterial and archael phyla in soil, water and airborne dust lifted by wind tunnel treatment. Bacterial and archael phyla abundances were calculated individually per kingdom. \\label{fig:phyla}'>>=
...
<<cyano_out, echo=FALSE, fig.height=3,warning=FALSE, cache=TRUE,fig.cap='Relative abundance of cyanobacterial genera in soil, water and airborne dust lifted by wind tunnel treatment. Abundances are relative wo the whole bacterial community. \\label{fig:cyano}'>>=
print(cyano.plot)
@
...
<<nmds_out, echo=FALSE, fig.height=6, fig.cap='NMDS visualisation of prokaryotic community structure in soil (sand dunes, claypan, and nebkha) and airborne dust (from sand dunes). \\label{fig:nmds}', cache=TRUE>>=
